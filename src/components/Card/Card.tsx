...
const Card = (props: Props) => {
  ...
  return (
    <div className="border-2 transition-shadow border-gray-50 rounded-lg p-2 w-full max-w-xs card">
      <div className="card__image_wrapper">
        <img src={imageSrc} alt={cardTitle} className="mx-auto card__image" />
      </div>
      <span className="inline-block my-3 w-full text-center font-medium capitalize text-2xl text-gray-500 card__title">
        {cardTitle}
      </span>
    </div>
  );
